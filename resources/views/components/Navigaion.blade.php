...
<nav  class="bg-white border-gray-200 dark:bg-gray-900 fixed top-0 start-0 z-50 w-full ">
    ...
    <div class="navi items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
                <a href="{{ url('/') }}" class="block py-2 px-3 rounded md:p-0 active md:bg-transparent" aria-current="page">@lang('messages.home')</a>
            </li>
            <li>
            ...
            <li>
                ...
                <div id="dropdownNavbar" class="z-10 hidden  font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <li>
                        <a href="{{ url('/merchant') }}" class="block px-4 py-2 hover:bg-red-700 ">@lang('messages.merchant')</a>
                    </li>
                    <li>
                        <a href="{{ url('/delivery') }}" class="block px-4 py-2 hover:bg-red-700 ">@lang('messages.delivery')</a>
                    </li>
