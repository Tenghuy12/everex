    ...
    <div class="flex items-center values justify-center ">
        ...
        <ul class="">
            <li class="mt-5 flex flex-row  text-center justify-center items-center">
                <a href="#" class="a-right mr-3 ml-2 text-white">@lang('about.speed')</a> <p class="text-lg">@lang('about.sub_speed')</p>
            </li>
            <li class="mt-5 flex text-center justify-center items-center">
                <p class="text-md mr-3">@lang('about.sub_efficiency')</p> <a href="#" class="a-left mr-2 text-white">@lang('about.efficiency')</a>
            </li>
            <li class="mt-5 flex text-center justify-center items-center">
                <a href="#" class="a-right mr-3 ml-2 text-white">@lang('about.excellence')</a> <p class="text-lg">@lang('about.sub_excellence')</p>
            </li>
            <li class="mt-5 flex text-center justify-center items-center">
                <p class="text-lg lg:text-2xl mr-3 ">@lang('about.sub_dedication')</p> <a href="#" class="a-left mr-2 text-white">@lang('about.dedication')</a>
            </li>
        </ul>
